                  ...
                  <div class="collapse navbar-collapse text-center " id="collapsenavbar">
                    <ul class="nav navbar-nav ml-auto navbar-right ">
                      ...
                      <li class="dropdown" class="nav-item"  >
                        <a  class="nav-link text-white"  class="dropdown-toggle" data-toggle="dropdown" href=""><i class="fa fa-user"></i>
                         <b class="caret"></b></a>
                            <ul class="dropdown-menu mr-auto">
                               ...
                               <li>
                                  <a class="nav-link text-dark" href="../requester/logout.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                              </li>
                           </ul>
                      </li>
                    </ul>
   ...
   <nav class="navbar bg-dark navbar-dark  ">
    ...
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link text-white" href="workorder.php">
      ...
      <li class="nav-item">
       <a class="nav-link text-white" href="assets.php">
        <i class="fas fa-database"></i>
        Assets
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link text-white" href="technician.php">
        <i class="fab fa-teamspeak"></i>
        Technician
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link text-white" href="requester.php">
        <i class="fas fa-users"></i>
        Requester
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link text-white" href="sellreport.php">
        <i class="fas fa-table"></i>
        Sell Report
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link text-white" href="workreport.php">
        <i class="fas fa-table"></i>
        Work Report
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link text-white" href="cp1.php">
